...
class SalvarPedido(View):
    ...
    def get(self, *args, **kwargs):
        ...
        qtd_total_carrinho = f_produto.f_cart_total_qtd(carrinho)
        valor_total_carrinho = f_produto.f_cart_totals(carrinho)

        pedido = Pedido(
            usuario=self.request.user,
            preco_t=valor_total_carrinho,
        ...
        ItemPedido.objects.bulk_create(
            [
                ItemPedido(
                    ...
                    prec_promo=v['preco_quantitativo_promocional'],
